...
export function AdminSidebar() {
  ...
  return (
    <div className="relative flex z-10">
      <div
        className={cn(
          "flex flex-col bg-white/80 backdrop-blur-lg border-r border-slate-200 text-slate-800 transition-all duration-300 ease-in-out",
      ...
      >
        <div className="flex items-center h-16 px-4 border-b border-slate-200">
          <div
            ...
            >
              <div className="w-8 h-8 bg-indigo-500/10 border border-indigo-200 p-2 flex items-center justify-center rounded-lg shadow-sm">
            ...
            return (
              <div key={item.name} className="relative group">
                <Button
                  variant="ghost"
                  className={cn(
                    "w-full gap-3 text-slate-600 hover:bg-indigo-50 hover:text-indigo-700 transition-all duration-200",
                    isCollapsed ? "justify-center px-2" : "justify-start",
                    isActive && "bg-indigo-100 text-indigo-700 font-semibold hover:bg-indigo-100 hover:text-indigo-700",
                  )}
